...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btb_SALIR1 = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        CONTRASENA_INGRESO1 = new javax.swing.JPasswordField();
        USUARIO_INGRESO1 = new javax.swing.JTextField();
        ...
        jFrame1.getContentPane().add(CONTRASENA_INGRESO, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 356, 330, 30));
        ...
        jFrame1.getContentPane().add(USUARIO_INGRESO, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 330, 30));
        ...
        jFrame1.getContentPane().add(btb_ACCEDER, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 480, 190, 50));
        ...
        jFrame1.getContentPane().add(btb_SALIR, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 480, 190, 50));

        lbl_fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login-1.jpeg"))); // NOI18N
        jFrame1.getContentPane().add(lbl_fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 570));

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btb_SALIR1.setBackground(new java.awt.Color(72, 137, 173));
        btb_SALIR1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btb_SALIR1.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                btb_SALIR1MouseMoved(evt);
            }
        });
        btb_SALIR1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btb_SALIR1MouseClicked(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btb_SALIR1MouseExited(evt);
            }
        });
        btb_SALIR1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Bahnschrift", 0, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 204, 204));
        jLabel2.setText("           SALIR");
        btb_SALIR1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 140, 50));

        getContentPane().add(btb_SALIR1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 480, 190, 50));

        jLabel4.setFont(new java.awt.Font("Bahnschrift", 0, 20)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 204, 204));
        jLabel4.setText("        ACCEDER");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 480, 140, 50));

        CONTRASENA_INGRESO1.setFont(new java.awt.Font("Arial Narrow", 0, 18)); // NOI18N
        CONTRASENA_INGRESO1.setForeground(new java.awt.Color(204, 204, 204));
        CONTRASENA_INGRESO1.setBorder(null);
        getContentPane().add(CONTRASENA_INGRESO1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 356, 330, 30));

        USUARIO_INGRESO1.setFont(new java.awt.Font("Arial Narrow", 0, 18)); // NOI18N
        USUARIO_INGRESO1.setForeground(new java.awt.Color(204, 204, 204));
        USUARIO_INGRESO1.setBorder(null);
        getContentPane().add(USUARIO_INGRESO1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 330, 30));

        lbl_fondo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login-1.jpeg"))); // NOI18N
        getContentPane().add(lbl_fondo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 570));
    ...
    private void btb_SALIR1MouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btb_SALIR1MouseMoved
        btb_SALIR.setBackground(new Color(36,83,115));
    }//GEN-LAST:event_btb_SALIR1MouseMoved

    private void btb_SALIR1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btb_SALIR1MouseClicked
        System.exit(0);
    }//GEN-LAST:event_btb_SALIR1MouseClicked

    private void btb_SALIR1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btb_SALIR1MouseExited
        btb_SALIR.setBackground(new Color(72,137,173));
    }//GEN-LAST:event_btb_SALIR1MouseExited
    ...
    private javax.swing.JPasswordField CONTRASENA_INGRESO1;
    private javax.swing.JTextField USUARIO_INGRESO;
    private javax.swing.JTextField USUARIO_INGRESO1;
    private javax.swing.JPanel btb_ACCEDER;
    private javax.swing.JPanel btb_SALIR;
    private javax.swing.JPanel btb_SALIR1;
